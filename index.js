...
function createWrappingComputed (attributeToWrap, defaultVal, readFunc, writeFunc) {
  attributeToWrap = attributeToWrap || ko.observable(defaultVal)
  return ko.computed({
    read: function () {
      return readFunc(attributeToWrap())
    },
    write: function (newValue) {
      attributeToWrap(writeFunc(newValue))
    },
    owner: this
  })
}
...
module.exports = {
  setIsSwedish: function(bool){
    isSwedish = bool
  },

  setLogging: function(_log){
    log = _log
  },
